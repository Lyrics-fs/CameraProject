...
public class CameraRenderer implements GLSurfaceView.Renderer {
    ...
    /** 在主线程触发 requestRender，避免部分机型上随机线程回调导致漏刷新 */
    private static final Handler FRAME_NOTIFY_HANDLER = new Handler(Looper.getMainLooper());
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        surfaceTexture.setOnFrameAvailableListener(
                ...
                FRAME_NOTIFY_HANDLER);

        // 先完成着色器编译再通知绑定相机：否则首帧可能在 program==0 时进入 onDrawFrame，只会清黑屏
        ...
        if (program != 0) {
            ...
            Log.e(TAG, "Shader program creation failed; preview will stay black until fixed");
        }
